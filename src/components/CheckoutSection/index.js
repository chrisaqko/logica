                                            ...
                                            <Grid container spacing={3}>
                                                ...
                                                <Grid item xs={12}>
                                                    <FormControlLabel
                                                        ...
                                                        label="Enviar a una dirección distinta a la de facturación?"
                                                    />
                                                </Grid>
                                                <Grid item xs={12}>
                                                ...
                                                <Grid item xs={12}>
                                                    <TextField
                                                        fullWidth
                                                        multiline
                                                        label="Nota sobre su pedido"
                                                        placeholder="Por favor, escriba aquí cualquier nota sobre su pedido."
                                                        name="note"
                                                        value={forms.note}
                                                        onChange={(e) => changeHandler(e)}
                                                        type="text"
                                ...
                                <Grid className="chCardBody">
                                    <Collapse in={tabs.payment} timeout="auto">
                                        ...
                                        <Collapse in={forms.payment_method === 'card'} timeout="auto">
                                            <Grid className="cardType">
                                                <Link to='/order_received' className="cBtn cBtnLarge cBtnTheme mt-20" type="submit">Proceder con el pago</Link>
                                            </Grid>
                                        </Collapse>
                                    </Collapse>
                                </Grid>
                                        ...
                                        <Table>
                                            <TableBody>
                                                ...
                                                <TableRow className="totalProduct">
                                                    <TableCell>Total del envío</TableCell>
                                                    <TableCell align="right">{cartList.length}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell>Otros montos</TableCell>
