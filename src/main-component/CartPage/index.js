...
const CartPage = (props) => {
  ...
  return (
    <Fragment>
      ...
      <PageTitle pageTitle={"Carrito de Compras"} pagesub={"Carrito de Compras"} />
      ...
      <Footer hclass={'wpo-site-footer'} NewsletterShow={false} InstagramShow={true} FooterShape={false} upperContactArea={true} />
      <Scrollbar />
    </Fragment>
  );
};
