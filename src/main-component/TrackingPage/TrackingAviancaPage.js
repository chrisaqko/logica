...
const TrackingPage = (props) => {
    ...
    return (
        <Fragment>
            ...
            <PageTitle pageTitle={'Rastree su pedido con envío aéreo'} pagesub={'Pedidos'} />
            <section className="wpo-calculation-section-s3 section-padding" >
                <div className="container">
                    <div className="wpo-calculation-section-wrapper">
                        <div className="row align-items-center">
                        <div className="row align-items-center">
                            <CustomIframe src="https://www.aviancacargo.com/index.aspx" title="Tracking LATAM Cargo" />
                        </div>
                        </div>
                    </div>
                </div>
